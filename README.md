...
This will compile all the test classes(src/test/java) and will place the result bytecode into target/test-classes directory (First generate the source code bytecode to run your test classes)
## mvn package
...
## mvn -o package
To run in offline mode when you're sure that all the required dependencies are available and you don't want maven to look for depdendcies from central repo.
## mvn -DskipTests package
To skip the test cases building
